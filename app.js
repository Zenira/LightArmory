...
app.locals.getHeroStars = function(grade, awakening){
	...
	if (awakening !== undefined && awakening > 0) {
		if (awakening == 1) starIcon = 'green_star.png';
		else if (awakening == 2) starIcon = 'blue_star.png';
		else if (awakening == 3) starIcon = 'purple_star.png';
		else if (awakening == 4) starIcon = 'orange_star.png';
		else if (awakening == 5) starIcon = 'red_star.png';
	}
